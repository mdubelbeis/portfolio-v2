...
const PROJECTS = [
    {
        ...
        projectBgImg: null,
        projectName: 'Behav.io',
        projectText: 'A web application that allows users to practice and record their behavioral interview answers.',
        projectTech: [
            'React',
            'Typescript',
            'Tailwind CSS',
    ...
    },
    {
        ...
        projectTech: ['React', 'Typescript', 'Tailwind CSS', 'Redux-ToolKit', 'React-Router'],
