...
const Skills: React.FC = () => {
  return (
    <section className="relative flex w-full flex-col items-center justify-start bg-slate-800 bg-blue-reaction bg-cover bg-center bg-no-repeat py-32 py-10 text-white bg-blend-overlay lg:flex-row lg:items-center lg:justify-center lg:gap-20 xl:gap-40">
      <div className="p-4">
        <h2 className="mb-2 font-hero-text text-4xl tracking-widest text-white md:text-5xl lg:text-7xl">SKILLS</h2>
      </div>
