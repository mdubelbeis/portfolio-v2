...
const Skills: React.FC = () => {
  return (
    <section className="relative flex w-full flex-col items-center justify-start bg-slate-800 bg-blue-reaction bg-cover bg-center bg-no-repeat px-4 py-32 text-white bg-blend-soft-light lg:flex-row lg:items-center lg:justify-center lg:gap-20 xl:gap-40">
      <div className="p-4">
