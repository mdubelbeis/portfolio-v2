...
const Hero: React.FC = () => {
  return (
    <div className="font-hero-text flex h-full flex-col items-center justify-center bg-slate-800 bg-blue-abstraction bg-cover bg-center bg-no-repeat py-24 text-center text-white bg-blend-soft-light">
