...
const Hero: React.FC = () => {
  return (
    <div className="relative py-32 flex flex-col items-center justify-center bg-slate-800 bg-hero-pattern bg-cover bg-no-repeat text-center font-hero-text text-white bg-blend-multiply">
