...
const Hero: React.FC = () => {
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center bg-slate-800 bg-hero-pattern bg-cover bg-no-repeat text-center font-hero-text text-white bg-blend-multiply">
      <div className="mb-24 flex h-72 w-72 flex-col justify-center gap-4 rounded-full bg-black border border-blue-300 bg-opacity-40 border-opacity-10 md:h-96 md:w-96 lg:h-[32rem] lg:w-[32rem]">
