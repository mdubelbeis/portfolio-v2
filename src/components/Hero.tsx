...
const Hero: React.FC = () => {
  return (
    <div className="font-hero-text flex h-screen flex-col items-center justify-center bg-slate-800 bg-code bg-cover bg-center bg-no-repeat px-10 py-28 text-center text-white bg-blend-multiply">
