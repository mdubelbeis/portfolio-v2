...
const About: React.FC = () => {
    return (
        <section className="font-hero-text flex flex-col items-center justify-center gap-6 bg-slate-100 py-32 tracking-wider text-black lg:gap-10 lg:tracking-wider">
