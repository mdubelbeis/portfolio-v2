...
const About: React.FC = () => {
  return (
    <section className="font-hero-text flex flex-col items-center justify-center gap-14 bg-slate-100 py-32 tracking-wider text-black md:px-8 lg:flex-row-reverse lg:gap-20 lg:py-72">
      ...
      <div className="flex max-w-2xl flex-col items-center justify-center gap-2 p-4 text-left text-lg">
        <div className="flex flex-col gap-2 md:ml-10">
          ...
          <em className="mt-8 text-lg font-semibold">Let me help your business grow.</em>
        </div>
