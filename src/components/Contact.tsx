  ...
  return (
    <nav className={`absolute left-0 top-0 md:h-full p-2 z-10`}>
      ...
      <div id="content-container" className="md:fixed h-full p-4 shadow-xl">
        ...
        >
          <li className="w-full border-[0.1rem] border-white shadow-xl p-2 rounded-full">
          ...
          <li className="w-full border-[0.1rem] border-white shadow-xl p-2 rounded-full hover:bg-slate-100">
