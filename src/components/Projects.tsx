...
const Projects: React.FC<ProjectProps> = ({ projects }) => {
  ...
  return (
    <section id="projects" className="flex flex-col items-center justify-center gap-4 bg-white px-4 text-center h-screen">
      ...
      <div className="relative top-28 text-blue-500">
